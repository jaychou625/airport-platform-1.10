...
(function(window, undefined) {
    ...
    var _INLINE_TAG_MAP = _toMap('a,abbr,acronym,b,basefont,bdo,big,br,button,cite,code,del,dfn,em,font,i,img,input,ins,kbd,label,monitor,q,s,samp,select,small,span,strike,strong,sub,sup,textarea,tt,u,var'),
        _BLOCK_TAG_MAP = _toMap('address,applet,blockquote,body,center,dd,dir,div,dl,dt,fieldset,form,frameset,h1,h2,h3,h4,h5,h6,head,hr,html,iframe,ins,isindex,li,monitor,menu,meta,noframes,noscript,object,ol,p,pre,script,style,table,tbody,td,tfoot,th,thead,title,tr,ul'),
...
KindEditor.plugin('baidumap', function(K) {
    ...
    self.clickToolbar(name, function() {
        var html = ['<div style="padding:10px 20px;">',
            ...
            '</div>',
            '<div class="ke-monitor" style="width:' + mapWidth + 'px;height:' + mapHeight + 'px;"></div>',
            '</div>'
        ].join('');
        var dialog = self.createDialog({
            name: name,
        ...
        var div = dialog.div,
            ...
            win, doc;
        var iframe = K('<iframe class="ke-textarea" frameborder="0" src="' + self.pluginsPath + 'baidumap/traffic.html" style="width:' + mapWidth + 'px;height:' + mapHeight + 'px;"></iframe>');
        ...
        K('.ke-monitor', div).replaceWith(iframe);
        // search monitor
...
KindEditor.plugin('map', function(K) {
    ...
    self.clickToolbar(name, function() {
        var html = ['<div style="padding:10px 20px;">',
            ...
            '</span>',
            '</div>',
            '<div class="ke-monitor" style="width:558px;height:360px;"></div>',
            '</div>'
        ].join('');
        var dialog = self.createDialog({
            name: name,
        ...
        var iframeHtml = ['<!doctype html><html><head>',
            ...
            ' };',
            ' monitor = new google.maps.Map(document.getElementById("map_canvas"), options);',
            ...
            '   if (status == google.maps.GeocoderStatus.OK) {',
            '     monitor.setZoom(11);',
            '     monitor.setCenter(results[0].geometry.location);',
        ...
        var iframe = K('<iframe class="ke-textarea" frameborder="0" src="' + self.pluginsPath + 'monitor/traffic.html" style="width:558px;height:360px;"></iframe>');
