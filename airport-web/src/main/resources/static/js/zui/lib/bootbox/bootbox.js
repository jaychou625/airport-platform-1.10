...
(function(root, factory) {
    ...
    /**
     * monitor a flexible set of arguments into a single returned object
     * if args.length is already one just return it, otherwise
     * use the properties argument to monitor the unnamed args to
     * object properties
    ...
    function mergeArguments(defaults, args, properties) {
        return $.extend(
            ...
            // monitor it to a proper options object
            mapArguments(
                args,
                properties
            )
    ...
    exports.prompt = function() {
        ...
        // and simply monitor that as keys: vals
